...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                $titleq = $_POST['title'];
                $titleq = htmlspecialchars($titleq, ENT_QUOTES, 'UTF-8');
                ...
                // SQL query to insert new thread
                $sql = "INSERT INTO `thread` ( `thread_title`, `thread_desc`, `thread_cat_id`, `thread_user_name`, `email_id` , `time`) VALUES ('$titleq', '$desc', '$thread_category_id', '$threadUser','$emailID', CURRENT_TIMESTAMP);";
                ...
                if ($result) {
                    ...
                    // Redirect to the same page or another page. Add the id to the url.
