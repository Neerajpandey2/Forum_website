...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="/PHP/Forum_website1/index.php">iDiscuss</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active" href="/PHP/Forum_website1/index.php">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="/PHP/Forum_website1/about.php">About</a></li>
            ...
            <form class="d-flex align-items-center" action="/PHP/Forum_website1/search.php" method="GET">
                ...
                <?php if (isset($_SESSION['username'])): ?>
                    ...
                    <div class="btn-group ms-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                            <li><a class="dropdown-item" href="/PHP/Forum_website1/user/user_profile.php">View Profile</a></li>
