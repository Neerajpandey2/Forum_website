...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($rows > 0) {
        ...
        if ($userExists && $emailExists) {
            header("Location: /PHP/Forum_website1/index.php?signupsuccess=false&exist=true&email=true&username=true");
        } elseif ($userExists) {
            header("Location: /PHP/Forum_website1/index.php?signupsuccess=false&exist=true&username=true");
        } elseif ($emailExists) {
            header("Location: /PHP/Forum_website1/index.php?signupsuccess=false&exist=true&email=true");
        }
        exit();
    } else {
